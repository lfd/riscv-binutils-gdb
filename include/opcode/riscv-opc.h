...
DECLARE_INSN(c_srli64, MATCH_C_SRLI64, MASK_C_SRLI64)
DECLARE_INSN(c_srai64, MATCH_C_SRAI64, MASK_C_SRAI64)
DECLARE_INSN(c_slli64, MATCH_C_SLLI64, MASK_C_SLLI64)
...
/* Ubadaddr is 0x43 in 1.9.1, but 0x43 is utval in 1.10/1.12.  */
DECLARE_CSR_ALIAS(ubadaddr, CSR_UTVAL)
/* Sbadaddr is 0x143 in 1.9.1, but 0x143 is stval in 1.10/1.12.  */
DECLARE_CSR_ALIAS(sbadaddr, CSR_STVAL)
/* Sptbr is 0x180 in 1.9.1, but 0x180 is satp in 1.10/1.12.  */
DECLARE_CSR_ALIAS(sptbr, CSR_SATP)
/* Mbadaddr is 0x343 in 1.9.1, but 0x343 is mtval in 1.10/1.12.  */
DECLARE_CSR_ALIAS(mbadaddr, CSR_MTVAL)
/* Mucounteren is 0x320 in 1.9.1, but 0x320 is mcountinhibit in 1.10/1.12.  */
DECLARE_CSR_ALIAS(mucounteren, CSR_MCOUNTINHIBIT)
/* Dscratch is 0x7b2 in 1.9.1, but 0x7b2 is dscratch0 in 1.10/1.12.  */
...
DECLARE_CAUSE("instruction guest page fault", CAUSE_INSTRUCTION_GUEST_PAGE_FAULT)
